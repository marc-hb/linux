...
/* Clocks frequency */
#define ADF_GEN6_KPT_COUNTER_FREQ	(100 * HZ_PER_MHZ)

/* Physical function fuses */
#define ADF_GEN6_FUSECTL0_OFFSET	0x2C8
#define ADF_GEN6_FUSECTL1_OFFSET	0x2CC
#define ADF_GEN6_FUSECTL2_OFFSET	0x2D0
#define ADF_GEN6_FUSECTL3_OFFSET	0x2D4
#define ADF_GEN6_FUSECTL4_OFFSET	0x2D8
#define ADF_GEN6_FUSECTL5_OFFSET	0x2DC
...
#define ADF_GEN6_MSIX_RTTABLE_OFFSET(i)		(0x409000 + ((i) * 0x04))
...
#define ADF_GEN6_ARB_OFFSET			0x0
...
#define ADF_GEN6_SVNCMT_CSR_MSG		0x640008
#define ADF_GEN6_FUSE_ANTI_RB		BIT(24)

/* Default ring mapping */
#define ADF_GEN6_DEFAULT_RING_TO_SRV_MAP		\
	(SYM << ADF_CFG_SERV_RING_PAIR_0_SHIFT |	\
...
#define ADF_GEN6_CSR_RINGMODECTL(bank)		(0x9000 + ((bank) << 2))

/* Specifies the traffic class to use for the transactions to/from the ring */
#define ADF_GEN6_RINGMODECTL_TC_OFFSET		16
...
#define ADF_GEN6_RINGMODECTL_TC_EN_OFFSET	19
...
#define ADF_GEN6_PVC1CTL_TCVCMAP_DEFAULT	0x80
...
/* Physical function fuses */
#define ADF_6XXX_ACCELENGINES_MASK	0x1FF
#define ADF_6XXX_ADMIN_AE_MASK		0x100
...
#define ADF_6XXX_KPT_DEFAULT_ENABLEMENT		0
