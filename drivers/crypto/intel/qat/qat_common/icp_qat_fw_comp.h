...
enum icp_qat_fw_comp_51_cmd_id {
	ICP_QAT_FW_COMP_51_CMD_LZ4_COMPRESS = 3,
	ICP_QAT_FW_COMP_51_CMD_LZ4_DECOMPRESS = 4,
	ICP_QAT_FW_COMP_51_CMD_LZ4S_COMPRESS = 5,
	ICP_QAT_FW_COMP_51_CMD_RESERVED_6 = 6,
	ICP_QAT_FW_COMP_51_CMD_RESERVED_7 = 7,
	ICP_QAT_FW_COMP_51_CMD_RESERVED_8 = 8,
	ICP_QAT_FW_COMP_51_CMD_RESERVED_9 = 9,
	ICP_QAT_FW_COMP_51_CMD_ZSTD_COMPRESS = 10,
	ICP_QAT_FW_COMP_51_CMD_ZSTD_DECOMPRESS = 11,
	ICP_QAT_FW_COMP_51_CMD_DELIMITER
};
