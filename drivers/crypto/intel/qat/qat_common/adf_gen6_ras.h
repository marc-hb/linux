...
#define ADF_GEN6_ERRSOU0_BIT				BIT(0)
...
#define ADF_GEN6_ERRSOU1_BITMASK ( \
...
#define ADF_GEN6_ERRMSK1_BITMASK ( \
 ...
 */
#define ADF_GEN6_RIMEM_PARERR_STS_UNCERR_BITMASK \
...
#define ADF_GEN6_RIMEM_PARERR_STS_FATAL_BITMASK \
 ...
 */
#define ADF_GEN6_TI_CI_PAR_STS_BITMASK \
	(BIT(0) | BIT(1) | BIT(3))
 ...
 */
#define ADF_GEN6_TI_PULL0FUB_PAR_STS_BITMASK \
 ...
 */
#define ADF_GEN6_TI_PUSHFUB_PAR_STS_BITMASK \
 ...
 */
#define ADF_GEN6_TI_CD_PAR_STS_BITMASK \
 ...
 */
#define ADF_GEN6_TI_TRNSB_PAR_STS_BITMASK \
	(BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4) | BIT(5) | BIT(6) | \
...
#define ADF_GEN6_ERRSOU2_CPP_CFC_ATT_INT_BITMASK \
	(BIT(2) | BIT(3) | BIT(4))

#define ADF_GEN6_ERRSOU2_PM_INT_BIT			BIT(18)

#define ADF_GEN6_ERRSOU2_BITMASK \
	(ADF_GEN6_ERRSOU2_SSM_ERR_BIT | \
	 ADF_GEN6_ERRSOU2_CPP_CFC_ERR_STATUS_BIT)

#define ADF_GEN6_ERRSOU2_DIS_BITMASK \
	(ADF_GEN6_ERRSOU2_SSM_ERR_BIT | \
	 ADF_GEN6_ERRSOU2_CPP_CFC_ERR_STATUS_BIT | \
	 ADF_GEN6_ERRSOU2_CPP_CFC_ATT_INT_BITMASK)
...
#define ADF_GEN6_IAINTSTATSSM_BITMASK \
 ...
 */
#define ADF_GEN6_UERRSSMSH_BITMASK			(BIT(0) | BIT(15))

/*
 * CERRSSMSH error bit
 * BIT(0) - Indicates one correctable error
 */
#define ADF_GEN6_CERRSSMSH_ERROR_BIT \
	(BIT(0) | BIT(15) | BIT(24))
 ...
 */
#define ADF_GEN6_INTMASKSSM_BITMASK \
	(BIT(0) | BIT(2) | BIT(4) | BIT(5) | BIT(6) | BIT(7))

/* CPP push or pull error */
#define ADF_GEN6_PPERR					0x8

#define ADF_GEN6_PPERR_BITMASK				(BIT(0) | BIT(1))

/*
 * SSM_FERR_STATUS error bit masks definitions
 */
#define ADF_GEN6_SCM_PAR_ERR_BITMASK			BIT(5)
#define ADF_GEN6_CPP_PAR_ERR_BITMASK \
	(BIT(0) | BIT(1) | BIT(2))
#define ADF_GEN6_UNEXP_CPL_ERR_BITMASK \
	(BIT(3) | BIT(4) | BIT(10) | BIT(11))
#define ADF_GEN6_RF_PAR_ERR_BITMASK			BIT(16)
 ...
 */
#define ADF_GEN6_CPP_CFC_ERR_CTRL_BITMASK		(BIT(0) | BIT(1))

#define ADF_GEN6_CPP_CFC_ERR_CTRL_DIS_BITMASK \
 ...
 */
#define ADF_GEN6_CPP_CFC_ERR_STATUS_CLR_BITMASK (BIT(0) | BIT(1) | BIT(2))
...
#define ADF_GEN6_ERRSOU3_RICPPINTSTS_BITMASK		(BIT(1) | BIT(6))
#define ADF_GEN6_ERRSOU3_TICPPINTSTS_BITMASK		(BIT(2) | BIT(5))
...
#define ADF_GEN6_ERRSOU3_BITMASK ( \
	(ADF_GEN6_ERRSOU3_TIMISCSTS_BIT) | \
	(ADF_GEN6_ERRSOU3_RICPPINTSTS_BITMASK) | \
	(ADF_GEN6_ERRSOU3_TICPPINTSTS_BITMASK) | \
...
#define ADF_GEN6_ERRSOU3_DIS_BITMASK ( \
	(ADF_GEN6_ERRSOU3_TIMISCSTS_BIT) | \
	(ADF_GEN6_ERRSOU3_RICPPINTSTS_BITMASK) | \
	(ADF_GEN6_ERRSOU3_TICPPINTSTS_BITMASK) | \
	(ADF_GEN6_ERRSOU3_VFLRNOTIFY_BIT) | \
...
#define ADF_GEN6_RLT_ERRLOG_BITMASK	(BIT(0) | BIT(1) | BIT(2) | BIT(3))
...
#define ADF_GEN6_TIMSCCTL_RELAY_BITMASK (BIT(1) | BIT(2) | BIT(30))
 ...
 */
#define ADF_GEN6_RICPPINTSTS_BITMASK \
 ...
 */
#define ADF_GEN6_RICPPINTCTL_BITMASK \
 ...
 */
#define ADF_GEN6_TICPPINTSTS_BITMASK \
	(BIT(0) | BIT(1) | BIT(2))
 ...
 *	    CPP/RF Parity error
 */
#define ADF_GEN6_TICPPINTCTL_BITMASK \
	(BIT(0) | BIT(1) | BIT(2) | BIT(3) | BIT(4))
...
#define ADF_GEN6_GENSTS_DEVICE_STATE_BITMASK		(BIT(0) | BIT(1))
#define ADF_GEN6_GENSTS_RESET_TYPE_BITMASK		(BIT(2) | BIT(3))
