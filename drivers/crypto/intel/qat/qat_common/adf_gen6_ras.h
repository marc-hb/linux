...
#define ADF_GEN6_RIMEM_PARERR_STS_CERR_BITMASK \
...
#define ADF_GEN6_CPP_PAR_ERR_BITMASK			(BIT(0) | BIT(1) | BIT(2))
#define ADF_GEN6_UNEXP_CPL_ERR_BITMASK			(BIT(3) | BIT(4) | BIT(10) | BIT(11))
 ...
 */
#define ADF_GEN6_RICPPINTSTS_BITMASK			(BIT(0) | BIT(1) | BIT(2) | BIT(3))
 ...
 */
#define ADF_GEN6_TICPPINTSTS_BITMASK			(BIT(0) | BIT(1) | BIT(2))
...
#define ADF_GEN6_GENSTS_DEVICE_STATE_BITMASK		GENMASK(1, 0)
#define ADF_GEN6_GENSTS_RESET_TYPE_BITMASK		GENMASK(3, 2)
