...
#define	X86_FEATURE_AVX10		KVM_X86_CPU_FEATURE(0x7, 1, EDX, 19)
#define	X86_FEATURE_OPMASK		KVM_X86_CPU_FEATURE(0xD, 0, EAX, 5)
#define	X86_FEATURE_ZMM_HI256		KVM_X86_CPU_FEATURE(0xD, 0, EAX, 6)
#define	X86_FEATURE_HI16_ZMM		KVM_X86_CPU_FEATURE(0xD, 0, EAX, 7)
...
#define X86_FEATURE_AVX10_256		KVM_X86_CPU_FEATURE(0x24, 0, EBX, 17)
#define X86_FEATURE_AVX10_512		KVM_X86_CPU_FEATURE(0x24, 0, EBX, 18)
...
#define X86_PROPERTY_PMU_EXT_EXTENDED_FEATURES		KVM_X86_CPU_PROPERTY(0x23, 0, EBX, 0, 31)
#define X86_PROPERTY_PMU_EXT_GP_COUNTERS_BIT_MASK	KVM_X86_CPU_PROPERTY(0x23, 1, EAX, 0, 31)
...
#define X86_PROPERTY_AVX10_VERSION		KVM_X86_CPU_PROPERTY(0x24, 0, EBX, 0, 7)
