...
#define ARCH_PERFMON_EVENTSEL_EN_PT_LOG			(1ULL << 38)
...
#define INTEL_FIXED_BASIC_BITS_MASK				\
...
#define ARCH_PERFMON_EVENTS_MAX_COUNT			16
...
#define ARCH_PERFMON_ARCH_EVENTS_LEAF		0x3
...
extern void intel_pt_interrupt(void);
#else
static inline void intel_pt_handle_vmx(int on)
{

}
static inline void intel_pt_interrupt(void) {}
#endif
